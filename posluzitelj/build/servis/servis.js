import { __dirname, dajPortServis } from '../zajednicko/esm_pomocnik.js';
...
konfig.ucitajKonf().then(pokreniServer).catch((error) => {
...
function pripremiPutanjeAutentifikacija(port) {
